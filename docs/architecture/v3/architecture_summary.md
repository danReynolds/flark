...
The 2026-08-02 projected-BlockQuote addendum narrows the final sentence above:
the admitted depth-one single-Paragraph quote now composes parser-certified
strong, emphasis, and inline-code facts through disjoint physical-line
coordinates on native and real Worker/Wasm. Marker-free presentation remains
stable during recertification on the same input client. “Quotes” in the open
scope now means nested or multi-child shapes plus authenticated local
restart/convergence, not inline composition for the admitted slice.
