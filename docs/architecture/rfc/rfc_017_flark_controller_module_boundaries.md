...
> [v4 build plan](../v4/build_plan.md) control the active product. The controller
> layout and paths below are superseded.
...
- `packages/flark/lib/widgets/flark/controllers/`
- `packages/flark/lib/widgets/flark/commands/`
- `packages/flark/lib/widgets/flark/logic/`
- `packages/flark/lib/widgets/flark/engine/`
...
```text
packages/flark/lib/widgets/flark/
  controller/
    flark_controller.dart
...
- `controllers/flark_value_mutation_coordinator.dart`
- `controllers/undo_stack.dart`
- `controllers/flark_differ.dart`

### 7.2 Move into `core/syntax`

- `controllers/flark_syntax_sync_coordinator.dart`
- `controllers/flark_predictive_reconciler.dart`
