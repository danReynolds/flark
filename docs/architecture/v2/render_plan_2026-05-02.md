...
- `FlarkRenderPlan` contains render blocks and metadata.
...
- Display ranges are derived through `FlarkProjection`.
...
- `FlarkRenderOverlayPlan` turns render descriptors into stable overlay
