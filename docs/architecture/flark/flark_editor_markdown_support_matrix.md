...
**Scope**: live editor parse/projection/render/editing UX plus flark
...
| Feed/card rollout | Supported (current app surfaces) | Feed excerpt markdown previews now render through `PostReadMarkdown` with flark clamp + read-more overlay |
