...
pub use document::{
    ...
    DocumentViewportRowPresentation, DocumentViewportRowSemanticCapabilities,
    DOCUMENT_PROJECTION_EDIT_CELL_BLOCK_PREFIX_PLAN_FLAGS,
    DOCUMENT_PROJECTION_EDIT_CELL_BLOCK_TRANSITION_FLAGS,
    DOCUMENT_PROJECTION_EDIT_CELL_CHAIN_RESULT, DOCUMENT_PROJECTION_EDIT_CELL_EMPTY_LITERAL_RESULT,
    DOCUMENT_PROJECTION_EDIT_CELL_EXACT_SCALAR_FLAGS,
    DOCUMENT_PROJECTION_EDIT_CELL_KNOWN_FLAGS_MASK,
    ...
    DOCUMENT_PROJECTION_EDIT_CELL_LITERAL_WORD_FLAGS, DOCUMENT_PROJECTION_EDIT_CELL_MATCHER_MASK,
    ...
    DOCUMENT_PROJECTION_EDIT_CELL_TERMINAL_SPACE_BLOCKED, DOCUMENT_TABLE_CELL_ALIGNMENT_MASK,
...
pub const CAPABILITY_BITS: &[(&str, u64)] = &[
    ...
    ("PROJECTION_EDIT_CELLS_V5", 1 << 36),
    ("LITERAL_SAFE_ENVELOPES_V3", 1 << 37),
];
