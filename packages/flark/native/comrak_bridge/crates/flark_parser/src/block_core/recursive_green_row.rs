...
//! Parser-semantic renderable-row projection and inline-leaf selection over
//! generic recursive Green storage.

use std::{fmt, ops::Range};

use flark_engine::parser_internal::{
    M11ParserSourceRangeAuthority, M11RecursiveGreenError, M11RecursiveGreenFrameFence,
    M11RecursiveGreenFrameId, M11RecursiveGreenFrameQueryError, M11RecursiveGreenKind,
    M11RecursiveGreenPoint, M11RecursiveGreenQueryReceipt, M11RecursiveGreenRenderableRow,
    M11RecursiveGreenRoot, M11RecursiveGreenRowQueryLimits, M11RecursiveGreenRowWindow,
