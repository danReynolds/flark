  ...
  testWidgets(
    ...
    (tester) async {
      ...
      try {
        ...
        final openingGeneration = probe.controller.sourceGeneration + 8;
        ...
        final closingGeneration = probe.controller.sourceGeneration + 4;
...
Iterable<String> _cleanNeutralGap(
  ...
  final first = hasPrecedingRow ? 1 : 0;
  ...
  for (final paint in paints) {
    ...
    for (var rowIndex = 0; rowIndex < actualRows.length; rowIndex += 1) {
      ...
      for (var runIndex = 0; runIndex < actual.runs.length; runIndex += 1) {
        ...
        expect(
          actualRun.sourceExact,
          expectedRun.sourceExact,
          reason: operation,
        );
