...
void main() {
  test('flark_flutter_advanced exposes the full public surface', () {
  ...
  test('flark_flutter_advanced keeps a deliberate barrel shape', () {
    final barrel = File('lib/flark_flutter_advanced.dart').readAsStringSync();

    expect(barrel, contains("export 'package:flark/flark_adapter.dart';"));
    expect(barrel, contains("export 'src/v2/flutter/flutter.dart';"));
    expect(barrel, isNot(contains("export 'src/v3/flutter/flutter.dart';")));
    expect(barrel, isNot(contains("package:flark/src/")));
