...
void main() {
  final matrix = _object(
    '../flark/test/fixtures/v4/input_window_matrix_v1.json',
  );
  ...
  test('binds every resolved selection to flark-owned Rust anchors', () {
    ...
    expect(authority['canonicalOwner'], 'flark');
    expect(
  ...
  test('freezes callback authority and bounds every represented window', () {
    ...
    expect(selectionAuthority['canonicalOwner'], 'flark');
    expect(
