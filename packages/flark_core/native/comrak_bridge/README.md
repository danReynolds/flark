...
This workspace is the Rust implementation bundled by `flark_core`'s Dart
...
builds invoke `packages/flark_core/hook/build.dart`, which compiles the target
artifact and registers it as `package:flark_core/src/native/bindings.dart`.
