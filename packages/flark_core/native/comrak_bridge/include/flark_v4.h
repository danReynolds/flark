...
#define FLARK_V4_CAPABILITY_LITERAL_SAFE_ENVELOPE_CLOSURE_V1 UINT64_C(0x0000000008000000)
#define FLARK_V4_CAPABILITY_PROJECTION_EDIT_CELLS_V1 UINT64_C(0x0000000010000000)
...
#define FLARK_V4_CAPABILITY_PROJECTION_EDIT_CELLS_V3 UINT64_C(0x0000000200000000)
#define FLARK_V4_CAPABILITY_PROJECTION_EDIT_CELLS_V4 UINT64_C(0x0000000400000000)
#define FLARK_V4_CAPABILITY_BOUNDED_PENDING_PRESENTATION_PLANS_V1 UINT64_C(0x0000000800000000)
#define FLARK_V4_CAPABILITY_PROJECTION_EDIT_CELLS_V5 UINT64_C(0x0000001000000000)
#define FLARK_V4_CAPABILITY_LITERAL_SAFE_ENVELOPES_V3 UINT64_C(0x0000002000000000)
...
#define FLARK_V4_EDIT_PRESENTATION_JOIN_FENCED_CODE UINT32_C(20)
#define FLARK_V4_EDIT_PRESENTATION_DELETE_INLINE_OWNER UINT32_C(21)
...
#define FLARK_V4_INLINE_FACT_PROJECTION_EDIT_CELL UINT32_C(16)
#define FLARK_V4_INLINE_FACT_PENDING_PRESENTATION_PLAN UINT32_C(17)
#define FLARK_V4_INLINE_FACT_PENDING_PRESENTATION_STEP UINT32_C(18)
#define FLARK_V4_INLINE_FACT_PENDING_PRESENTATION_ROW UINT32_C(19)
#define FLARK_V4_PENDING_PRESENTATION_PLAN_SEQUENCE_LENGTH_MASK UINT32_C(0x000000ff)
#define FLARK_V4_PENDING_PRESENTATION_PLAN_STEP_COUNT_SHIFT UINT32_C(8)
#define FLARK_V4_PENDING_PRESENTATION_PLAN_REPLACED_ROW_COUNT_SHIFT UINT32_C(16)
#define FLARK_V4_PENDING_PRESENTATION_STEP_PREFIX_LENGTH_MASK UINT32_C(0x000000ff)
#define FLARK_V4_PENDING_PRESENTATION_STEP_ROW_COUNT_SHIFT UINT32_C(8)
#define FLARK_V4_PENDING_PRESENTATION_ROW_KIND_MASK UINT32_C(0x0000ffff)
#define FLARK_V4_PENDING_PRESENTATION_ROW_FACT_COUNT_SHIFT UINT32_C(16)
...
#define FLARK_V4_LITERAL_EDIT_CLASS_SINGLE_ASCII_ASTERISK_INSERTION UINT32_C(3)
#define FLARK_V4_LITERAL_EDIT_CLASS_SINGLE_ASCII_LITERAL_UNIT_DELETION UINT32_C(4)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCHER_MASK UINT32_C(0x00ff)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_ANY_NO_CRLF_SPLICE UINT32_C(0x0001)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_ASCII_LITERAL_SPLICE_IN_LITERAL UINT32_C(0x0002)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_INSERT_SINGLE_ASCII_SPACE_AT_POINT UINT32_C(0x0003)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_DELETE_ONE_ASCII_UNIT_IN_LITERAL UINT32_C(0x0004)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_APPEND_ASCII_LITERAL_AT_LINE_END UINT32_C(0x0005)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_INSERT_EXACT_SCALAR_AT_POINT UINT32_C(0x0006)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_EXACT_SPLICE_REPLACE_BLOCK_SHELL UINT32_C(0x0007)
#define FLARK_V4_PROJECTION_EDIT_CELL_MATCH_SIMPLE_BLOCK_PREFIX_PLAN UINT32_C(0x0008)
#define FLARK_V4_PROJECTION_EDIT_CELL_SIMPLE_BLOCK_PLAN_BYTES_MASK UINT32_C(0x00ffffff)
#define FLARK_V4_PROJECTION_EDIT_CELL_SIMPLE_BLOCK_PLAN_ACTIVATION_SHIFT UINT32_C(24)
#define FLARK_V4_PROJECTION_EDIT_CELL_SIMPLE_BLOCK_PLAN_ACTIVATION_MASK UINT32_C(0xff000000)
#define FLARK_V4_PROJECTION_EDIT_CELL_RETAIN_BLOCK_SHELL UINT32_C(0x0100)
#define FLARK_V4_PROJECTION_EDIT_CELL_RETAIN_OUTSIDE UINT32_C(0x0200)
#define FLARK_V4_PROJECTION_EDIT_CELL_PRESENT_EXACT UINT32_C(0x0400)
#define FLARK_V4_PROJECTION_EDIT_CELL_CHAIN_RESULT UINT32_C(0x0800)
#define FLARK_V4_PROJECTION_EDIT_CELL_TERMINAL_SPACE_BLOCKED UINT32_C(0x1000)
#define FLARK_V4_PROJECTION_EDIT_CELL_REPLACE_BLOCK_SHELL UINT32_C(0x2000)
#define FLARK_V4_PROJECTION_EDIT_CELL_EMPTY_LITERAL_RESULT UINT32_C(0x4000)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_KIND_MASK UINT32_C(0x0000000f)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_PREFIX_SHIFT UINT32_C(4)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_PREFIX_MASK UINT32_C(0x00000ff0)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_PARAMETER_SHIFT UINT32_C(12)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_PLAIN UINT32_C(1)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_ATX_HEADING UINT32_C(2)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_BLOCK_QUOTE UINT32_C(3)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_LIST_ITEM UINT32_C(4)
#define FLARK_V4_PROJECTION_EDIT_CELL_RESULT_SHELL_REMOVED UINT32_C(5)
