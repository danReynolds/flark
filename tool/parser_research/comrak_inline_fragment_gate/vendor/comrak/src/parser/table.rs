...
pub(super) struct Row<'t> {
    pub(super) paragraph_offset: usize,
    pub(super) cells: Vec<Cell<'t>>,
}

pub(super) struct Cell<'t> {
    pub(super) start_offset: usize,
    pub(super) end_offset: usize,
    pub(super) internal_offset: usize,
    pub(super) content: Cow<'t, str>,
}

pub(super) fn row(string: &str, spoiler: bool) -> Option<Row<'_>> {
