...
void main() {
  final coreCases = _loadCases(
    sovereignFixturePath('commonmark/upstream/common_mark_tests.json'),
  );
  final gfmCases = _loadCases(
    sovereignFixturePath('commonmark/upstream/gfm_tests.json'),
  );
  final deviations = _loadDeviationRegister(
    sovereignFixturePath('commonmark/native_parity_deviation_register.json'),
  );
