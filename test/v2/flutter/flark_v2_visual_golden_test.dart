  ...
  group('Flark v2 visual contracts', () {
    testWidgets('overview surfaces stay visually stable', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/flark_v2_surfaces.png'),
      );
    });
    ...
    testWidgets('live rendered editing surface stays visually stable', (
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_live_rendered_editing.png'),
      );
    });
    ...
    testWidgets('live rendered edge cases stay visually stable', (
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_live_edge_cases.png'),
      );
    });
    ...
    testWidgets('inline styling and wrapping stay visually stable', (
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_inline_wrapping.png'),
      );
    });
    ...
    testWidgets('code fence regions stay visually stable', (tester) async {
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_code_fences.png'),
      );
    });
    ...
    testWidgets('blockquote regions stay visually stable', (tester) async {
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_blockquotes.png'),
      );
    });
    ...
    testWidgets('tasks, tables, and overlays stay visually stable', (
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_tasks_tables_overlays.png'),
      );
    });
    ...
    testWidgets('compact mixed markdown layout stays visually stable', (
      ...
      await expectLater(
        find.byKey(_goldenKey),
        matchesGoldenFile('goldens/flark_v2_compact_mixed.png'),
      );
    });
  });
}

const _goldenKey = Key('flark-v2-visual-golden');
