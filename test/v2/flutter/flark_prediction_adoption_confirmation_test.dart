...
import 'package:flark/src/v2/flutter/flark_flutter_controller.dart'
    show
...
void main() {
  ...
  test('an armed wrap adopts with its authored claim parser-confirmed', () async {
    expect(flarkDebugValidatePredictionAdoption, isTrue,
    ...
    expect(
      flarkDebugUnconfirmedPredictionRanges,
      unconfirmedBefore,
      reason: 'the canonical armed-wrap flow must confirm all predicted '
