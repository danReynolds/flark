  ...
  group('createNativeComrakBridge', () {
    test('throws when library is missing', () {
      expect(
        () => createNativeComrakBridge(
          overrideLibraryPath: '/definitely/missing/libflark_comrak_bridge.so',
        ),
        throwsA(
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        // Without the raised threshold this parse routes through
        // Isolate.run, whose reply port never fires inside flutter_test's
        // fake-async zone — this await would hang until the test times out.
