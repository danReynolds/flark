...
void main() {
  ...
  test('a mid-size document parses synchronously past the fixed threshold', () {
    ...
    expect(
      ...
      lessThan(60000),
      reason:
          'stay under the adaptive ceiling’s 64 KiB starting value '
    ...
    expect(
      ...
      isTrue,
      reason:
          'the adaptive ceiling must afford a 40 KiB document without '
  ...
  test(
    'the keystroke path keeps its debounce (device-gated; RFC 022 §6)',
    () async {
      ...
      expect(
        ...
        isFalse,
        reason:
            'a plain insertText declares no authored markers, so it must '
